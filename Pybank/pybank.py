...
budget_data_csv = os.path.join ("\Users\pangz\Desktop\Python Challenge\Python-Challenge\Python-Challenge\PyBank\Resources\budget_data.csv)
with open(budeget_data_csv, newline=") as csvfile:
...
with open(file_to_output, "w") as txt_file:
            ...
            total_profit = f"/nTotal: ${sum(total)}"
            print(total_profit)
